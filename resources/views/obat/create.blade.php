        ...
        <div class="col-lg">
            <div class="card shadow mb-4">
                <div class="card-body">
                    ...
                    <form action="/obat" method="POST" role="form" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label>Nama Obat</label>
                            <input type="text" class="form-control" id="nama" name="nama" value="{{ Session::get('nama') }}" placeholder="Masukan Nama Obat" autofocus autocomplete="off">
                        </div>
                        <div class="form-group">
